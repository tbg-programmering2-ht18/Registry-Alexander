    ...
    class Program
    {
        ...
        private static void Setup()
        {
            ...
            if (!File.Exists(urFilename))
            {
                ...
                f.Close();
                userPasswdDict.Add("alexander", "yeet");
                userPasswdDict.Add("nummer2", "twoo");
                userPasswdDict.Add("nummer3", "threee");
            ...
            if (!File.Exists(arFilename))
            {
                ...
                f.Close();
                userAnimalDict.Add("alexander", new Animal("Magiker", "Per", "Floop", true));
                userAnimalDict.Add("nummer2", new Animal("myra", "Klippan", "meow", false));
